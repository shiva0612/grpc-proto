...
type UserApiClient interface {
	// unary
	AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*StringResponse, error)
	// client streaming
...
func (c *userApiClient) AddUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*StringResponse, error) {
...
func (x *userApiAddUsersClient) Send(m *User) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userApiAddUsersClient) CloseAndRecv() (*StringResponse, error) {
...
func (x *userApiListUsersClient) Recv() (*User, error) {
	m := new(User)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *userApiListTheseUsersClient) Send(m *StringRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *userApiListTheseUsersClient) Recv() (*User, error) {
	m := new(User)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type UserApiServer interface {
	// unary
	AddUser(context.Context, *User) (*StringResponse, error)
	// client streaming
...
func (UnimplementedUserApiServer) AddUser(context.Context, *User) (*StringResponse, error) {
...
func (x *userApiAddUsersServer) SendAndClose(m *StringResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userApiAddUsersServer) Recv() (*User, error) {
	m := new(User)
...
func (x *userApiListUsersServer) Send(m *User) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *userApiListTheseUsersServer) Send(m *User) error {
	return x.ServerStream.SendMsg(m)
}

func (x *userApiListTheseUsersServer) Recv() (*StringRequest, error) {
	m := new(StringRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
